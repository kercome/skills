...
| `{SKILL_ROOT}/references/guidelines-landing-page.md` | Landing / marketing page |
| `{SKILL_ROOT}/references/guidelines-web-app.md` | Web app (default for generic design tasks) |
| `{SKILL_ROOT}/references/guidelines-mobile-app.md` | Mobile / app screen |
...
| 2 | mobile, app, iOS, Android, 移动端 | `{SKILL_ROOT}/references/guidelines-mobile-app.md` |
| 3 | landing, marketing, SaaS, 落地页, 营销 | `{SKILL_ROOT}/references/guidelines-landing-page.md` |
...
- **`search_style_guide`** — pass the `topic` matching the guideline loaded in Step 3. Extract keywords from the user's request for each domain. Refer to the tool's input schema for parameters. Additional hints:
