...
| `workflows/ardot-workflow.md`               | Load when orchestrating complex multi-section layouts.     |
| `workflows/design-to-code-workflow.md`      | Enable only for "Web App to code / React code generation" tasks. |
| `workflows/extract-style-guide-from-web.md` | Enable only for "extract style from an existing Web App" tasks. |
...
- `search_style_guide` (search for style candidates across design domains)
- `build_style_guide` (build complete design system from search selections)
- `fetch_variables`
- `apply_variables`
